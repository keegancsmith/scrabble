...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('scrabbleapp_game', 'winner_id')


    def backwards(self, orm):

        # Adding field 'Game.winner'
        db.add_column('scrabbleapp_game', 'winner', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='winner', null=True, to=orm['auth.User'], blank=True), keep_default=False)
