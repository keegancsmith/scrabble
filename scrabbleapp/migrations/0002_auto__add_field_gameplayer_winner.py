...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GamePlayer.winner'
        db.add_column('scrabbleapp_gameplayer', 'winner', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'GamePlayer.winner'
        db.delete_column('scrabbleapp_gameplayer', 'winner')
